...
# DATABASES = {
# 'default': dj_database_url.config(default=os.environ.get('postgresql://postgres:Kb5Ocz1pT5Q38UAUN0pr@containers-us-west-176.railway.app:5701/railway'), conn_max_age=1000)
# }
